...
public class WxMenuController {
    ...
    public String menuCreateSample(@PathVariable String appid) throws WxErrorException, MalformedURLException {
        ...
        return this.wxService.getMenuService().menuCreate(getMenu());
    }
    ...
    public WxMenu getMenu(){
        ...
        button11.setName("诉求提交");
        button11.setKey("Appeal_Submission");
        ...
        button21.setName("问题查询");
        button21.setKey("Question_Query");
        ...
        button31.setName("我的诉求");
        button31.setKey("My_Appeal");

        WxMenuButton button32 = new WxMenuButton();
        button32.setType(MenuButtonType.CLICK);
        button32.setName("进度查询");
        button32.setKey("Progress_Query");

        WxMenuButton button33 = new WxMenuButton();
        button33.setType(MenuButtonType.CLICK);
        button33.setName("账号绑定");
        button33.setKey("Binding_Account");
